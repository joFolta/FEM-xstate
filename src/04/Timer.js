    ...
    >
      ...
      <div className="display">
        ...
        <div className="elapsed" onClick={() => send({ type: "TOGGLE" })}>
          {/* Made this 0, so that we show 0 when timer is expired b/c the Math.ceil */}
          {/* Do this here and not in the machine as this would complicate the machine; */}
          {/* As this is only needed for the UI */}
